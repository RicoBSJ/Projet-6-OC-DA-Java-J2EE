...
public final class RechercheSiteForm {
    ...
    public Site rechercherSite( HttpServletRequest request ) {
        ...
        try {
            ...
            resultat = "Site trouvé !";
        } catch ( Exception e ) {
            resultat = "Echec de la recherche de site : une erreur imprévue est survenue, merci de réessayer dans quelques instants.";
            e.printStackTrace();
        }
        return site;
    }
