...
public final class InscriptionForm {
	...
	/*
	 * Appel Ã la validation des mots de passe reÃ§us, chiffrement du mot de passe
	 * et initialisation de la propriÃ©tÃ© motDePasse du bean
	 */
	...
	/*
	 * Appel Ã la validation du nom reÃ§u et initialisation de la propriÃ©tÃ© nom du
	 * bean
	 */
